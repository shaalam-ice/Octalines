    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlAccounts", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "OctlAccountTransactions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlAccountTransactions", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "OctlAdvancePayments",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlAdvancePayments", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlBrands", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlCategories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlContacts", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlCoupons", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "OctlCustomerCoupons",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    ExpiryDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UsedInSaleId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlCustomerCoupons", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlDeposits", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "OctlExpenseCategories",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlExpenseCategories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlExpenses", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlItems", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "OctlMessageLogs",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlMessageLogs", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "OctlMessageTemplates",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlMessageTemplates", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "OctlMoneyTransfers",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlMoneyTransfers", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "OctlPaymentTypes",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlPaymentTypes", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "OctlPurchaseReturns",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlPurchaseReturns", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlPurchases", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    GrandTotal = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    IsConvertedToSale = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlQuotations", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "OctlSaleReturns",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlSaleReturns", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlSales", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "OctlStockAdjustments",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlStockAdjustments", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "OctlStockLedgers",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ItemId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlStockLedgers", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "OctlStockTransfers",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ItemId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlStockTransfers", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "OctlStoreSettings",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    WhatsAppApiKey = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlStoreSettings", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlTaxes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlUnits", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlWarehouses", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlPurchaseReturnLines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OctlPurchaseReturnLines_OctlPurchaseReturns_PurchaseReturnId",
                        column: x => x.PurchaseReturnId,
                        principalTable: "OctlPurchaseReturns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "OctlPurchaseLines",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PurchaseId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlPurchaseLines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OctlPurchaseLines_OctlPurchases_PurchaseId",
                        column: x => x.PurchaseId,
                        principalTable: "OctlPurchases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "OctlPurchasePayments",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PurchaseId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlPurchasePayments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OctlPurchasePayments_OctlPurchases_PurchaseId",
                        column: x => x.PurchaseId,
                        principalTable: "OctlPurchases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlQuotationLines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OctlQuotationLines_OctlQuotations_QuotationId",
                        column: x => x.QuotationId,
                        principalTable: "OctlQuotations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "OctlSaleReturnLines",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlSaleReturnLines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OctlSaleReturnLines_OctlSaleReturns_SaleReturnId",
                        column: x => x.SaleReturnId,
                        principalTable: "OctlSaleReturns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlSaleLines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OctlSaleLines_OctlSales_SaleId",
                        column: x => x.SaleId,
                        principalTable: "OctlSales",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "OctlSalePayments",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SaleId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OctlSalePayments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OctlSalePayments_OctlSales_SaleId",
                        column: x => x.SaleId,
                        principalTable: "OctlSales",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OctlAccountTransactions_AccountId",
                table: "OctlAccountTransactions",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_OctlContacts_ContactType",
                table: "OctlContacts",
                column: "ContactType");

            migrationBuilder.CreateIndex(
                name: "IX_OctlCoupons_Code",
                table: "OctlCoupons",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_OctlExpenses_ExpenseCategoryId",
                table: "OctlExpenses",
                column: "ExpenseCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_OctlItems_Barcode",
                table: "OctlItems",
                column: "Barcode");

            migrationBuilder.CreateIndex(
                name: "IX_OctlPurchaseLines_PurchaseId",
                table: "OctlPurchaseLines",
                column: "PurchaseId");

            migrationBuilder.CreateIndex(
                name: "IX_OctlPurchasePayments_PurchaseId",
                table: "OctlPurchasePayments",
                column: "PurchaseId");

            migrationBuilder.CreateIndex(
                name: "IX_OctlPurchaseReturnLines_PurchaseReturnId",
                table: "OctlPurchaseReturnLines",
                column: "PurchaseReturnId");

            migrationBuilder.CreateIndex(
                name: "IX_OctlQuotationLines_QuotationId",
                table: "OctlQuotationLines",
                column: "QuotationId");

            migrationBuilder.CreateIndex(
                name: "IX_OctlSaleLines_SaleId",
                table: "OctlSaleLines",
                column: "SaleId");

            migrationBuilder.CreateIndex(
                name: "IX_OctlSalePayments_SaleId",
                table: "OctlSalePayments",
                column: "SaleId");

            migrationBuilder.CreateIndex(
                name: "IX_OctlSaleReturnLines_SaleReturnId",
                table: "OctlSaleReturnLines",
                column: "SaleReturnId");

            migrationBuilder.CreateIndex(
                name: "IX_OctlSales_InvoiceNumber",
                table: "OctlSales",
                column: "InvoiceNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_OctlStockAdjustments_ItemId",
                table: "OctlStockAdjustments",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_OctlStockLedgers_ItemId",
                table: "OctlStockLedgers",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_OctlStockLedgers_WarehouseId",
                table: "OctlStockLedgers",
                column: "WarehouseId");

            migrationBuilder.CreateIndex(
                name: "IX_OctlStockTransfers_ItemId",
                table: "OctlStockTransfers",
                column: "ItemId");
        }
